...
const TradeData = () => {
  ...
  return (
    <DashboardLayout>
      <div className="mb-8">
        <h1 className="text-3xl font-bold text-gray-900 dark:text-white">Trade & Balance of Payments</h1>
      ...
      <div className="mb-8 bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
        <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Exports, Imports & Trade Balance (Million USD)</h3>
      ...
      <div className="grid lg:grid-cols-2 gap-6 mb-8">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
          <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Export Composition</h3>
        ...
        {/* Import Categories */}
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
          <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-6">Import Composition</h3>
          <ResponsiveContainer width="100%" height={300}>
            <PieChart>
              <Pie
      ...
      {/* Key Insights */}
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-md p-6">
        <h3 className="text-lg font-bold text-gray-900 dark:text-white mb-4">Key Trade Insights FY 2023-24</h3>
        <div className="grid md:grid-cols-2 gap-6">
          <div>
            <h4 className="font-semibold text-gray-900 dark:text-white mb-3">Export Highlights</h4>
          ...
          <div>
            <h4 className="font-semibold text-gray-900 dark:text-white mb-3">Import Highlights</h4>
            <ul className="space-y-2 text-gray-700 dark:text-gray-300 text-sm">
              <li className="flex items-start">
